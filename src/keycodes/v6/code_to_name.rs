...
pub static SHORTNAMES: LazyLock<HashMap<u16, &str>> = LazyLock::new(|| {
    ...
    m.insert(0x7708, "M,8");
    m.insert(0x7709, "M,9");
    m.insert(0x770A, "M,10");
    m.insert(0x770B, "M,11");
    m.insert(0x770C, "M,12");
    m.insert(0x770D, "M,13");
    m.insert(0x770E, "M,14");
    m.insert(0x770F, "M,15");
    m.insert(0x7710, "M,16");
    m.insert(0x7711, "M,17");
    m.insert(0x7712, "M,18");
    m.insert(0x7713, "M,19");
    m.insert(0x7714, "M,20");
    m.insert(0x7715, "M,21");
    m.insert(0x7716, "M,22");
    m.insert(0x7717, "M,23");
    m.insert(0x7718, "M,24");
    m.insert(0x7719, "M,25");
    m.insert(0x771A, "M,26");
    m.insert(0x771B, "M,27");
    m.insert(0x771C, "M,28");
    m.insert(0x771D, "M,29");
    m.insert(0x771E, "M,30");
    m.insert(0x771F, "M,31");
    m.insert(0x7E00, "⌨,0");
    m.insert(0x7E01, "⌨,1");
    m.insert(0x7E02, "⌨,2");
    m.insert(0x7E03, "⌨,3");
